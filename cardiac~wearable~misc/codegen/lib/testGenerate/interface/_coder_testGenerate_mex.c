 ...
 * File: _coder_testGenerate_mex.c
 *
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&testGenerate_atexit);
  /* Module initialization. */
  testGenerate_initialize();
  /* Dispatch the entry-point. */
  unsafe_testGenerate_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
                                     ...
                                     int32_T nrhs, const mxArray *prhs[1])
{
  ...
  /* Call the function. */
  testGenerate_api(prhs[0], nlhs, outputs);
...
/*
 * File trailer for _coder_testGenerate_mex.c
 *
 * [EOF]
 */
